...
fn test_issue_key() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_last_event(crate::Event::KeyAnnounced { key: luke, who: 1 }.into());
    });
}
...
fn test_revoke_key() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_last_event(
            crate::Event::KeyAnnounced { key: BoundedVec::<u8, ConstU32<1024>>::try_from("Luke".as_bytes().to_vec()).unwrap(), who: 1 }.into(),
        );
        assert_ok!(KeystoreModule::revoke_key(RuntimeOrigin::signed(1), luke.clone()));
        System::assert_last_event(crate::Event::KeyRevoked { key: luke, who: 1 }.into());
    });
}
...
fn test_issue_encryption_key() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_last_event(crate::Event::EncryptionKeyIssued { who: 1 }.into());
    });
}
